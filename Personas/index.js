...
let seleccionPersonas = []

for (let i = 0; i < personas.length; i++) {
    seleccionPersonas.push({
...
function buscar() {
    ...
    if (valor !== "") {
        for (let i = 0; i < seleccionPersonas.length; i++) {
            if (seleccionPersonas[i].nombre.includes(valor)) {
                mostrarPersona += `
            <div id="personaContainer" style="background-color: ${seleccionPersonas[i].colorOjos}">
            <img src="${seleccionPersonas[i].imagen}" alt=""/>
            <h1>${seleccionPersonas[i].nombre}</h1>
            <p>${seleccionPersonas[i].edad}</p>
            <p>${seleccionPersonas[i].email}</p>
            <p>${seleccionPersonas[i].direccion}</p>
            </div>`
            }
        }
    } else {
    ...
    document.getElementById("div1").innerHTML = mostrarPersona
}
